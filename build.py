...
logo_w_b64 = base64.b64encode((root / 'logo-white.png').read_bytes()).decode()
...
assert '__LOGO_W_SRC__' in html, 'src.html에 __LOGO_W_SRC__ 플레이스홀더가 없습니다'
html = html.replace('__SAGA_SRC__', 'data:audio/mpeg;base64,' + b64)
html = html.replace('__LOGO_W_SRC__', 'data:image/png;base64,' + logo_w_b64)
